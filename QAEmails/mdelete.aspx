<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mdelete.aspx.cs" Inherits="QAEmails.mdelete" %>
...
<body>
    ...
    <br /><a href="sent.aspx">Sent</a> <br /> <a href="Inbox.aspx">Inbox</a><br /> <br />
     ...
     <%
         ...
         cmd.CommandText = "select EmailId,[From],Subject,Date from Emails where [To]='"+n+"' and Deleted='Y'";
